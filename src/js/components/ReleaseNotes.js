...
const ReleaseNotes = ({handleClick}) => {
    return <Section>
        ...
        <SectionBody>
            xxxx年xx月xx日、Ver 2.0.0 がリリースされました！最後の更新から 3 年近く放置されていたエクステンションですので既存ユーザの方々は驚かれたと思いますが、一念発起してやってやりましたよ。<br />
            ...
            <ul>
                ...
                <li>
                    このオプションページを追加
                    <ul>
                        <li>オプションページはバージョンアップの度に一度限り自動的に表示されます。</li>
                        <li>ビューごとにはてブの表示・非表示が選択できるようになりました。</li>
                        <li>ビューごとにはてブの表示位置を選択できるようになりました。</li>
                    </ul>
                </li>
            </ul>
